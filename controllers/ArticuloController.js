...
exports.list = async (req, res, next)=>{
    try {
        ...
        // -> NOTE : TESTS FAIL IF WE USE FOREIGN KEYS SO COMMENT THE LINE ABOVE AND UNCOMMENT THE LINES BELOW FOR ACTUAL IMPLEMENTATION
...
exports.update = async (req, res, next)=>{
    try {
        ...
        // console.log("UPDATING ARTICLE START");
        // console.log(registro);
        // console.log("UPDATING ARTICLE END");
        if (registro){
            ...
            // console.log("ARTICLE UPDATED TO START");
            // console.log(registro);
            // console.log("ARTICLE UPDATED END");
            res.status(200).json(registro);
        }else{
            res.status(404).send({
